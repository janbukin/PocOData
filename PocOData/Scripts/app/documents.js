$(document).ready(function () {
    ...
    window.viewModel = (function () {
        ...
        self.checkoutMany = function () {
            ...
            ajaxRequest("post", feedUrl + "/PocOData.Models.CheckOutMany", data)
                .done(function (result) {
        ...
        function Document(data, parent) {
            ...
            function updateDocument(data) {
                ...
                if (data["#PocOData.Models.CheckOut"]) {
                    self.checkoutUrl(data["#PocOData.Models.CheckOut"].target);
                }
                else {
                    self.checkoutUrl(null);
                }
                if (data["#PocOData.Models.Return"]) {
                    self.returnDocumentUrl(data["#PocOData.Models.Return"].target);
                }
                else {
